...
+ (void) boot: (UIWindow*) window
{
    ...
    NSDictionary* basic = @{SECTION: @"Luis Enrique", MENU: @[
 //                                   @{TITLE: @"Chọn đội hình", CLASS: @"CreateArray"},
                                    @{TITLE: @"Integer To String", CLASS: @"IntegerToString"},
                                    @{TITLE: @"Learn Array", CLASS: @"LearnArray"},
